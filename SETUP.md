...
6. 以下の設定でデプロイ：
   ...
   - 次のユーザーとして実行: 自分
   - アクセスできるユーザー: 全員
7. デプロイURLをコピーして、`science1.0.html` の `FIXED_GAS_URL` に設定

### 2. スプレッドシートの設定

スプレッドシートID: `1pWnEB7cuYNrvkZ2OvJC3xXp-XcK7I01rt0ICP3eEagE`
...
`science1.0.html` の以下の設定を確認：

```javascript
const FIXED_GAS_URL = "https://script.google.com/macros/s/YOUR_GAS_URL/exec";
const FIXED_SPREADSHEET_URL = "https://docs.google.com/spreadsheets/d/1pWnEB7cuYNrvkZ2OvJC3xXp-XcK7I01rt0ICP3eEagE/edit";
```
